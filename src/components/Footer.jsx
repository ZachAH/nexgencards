...
const socialLinks = [
  {
    label: 'Instagram',
    href: 'https://instagram.com/localcardshopmke',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/localcardshopmke',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: 'TikTok',
    href: 'https://tiktok.com/@localcardshopmke',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@localcardshopmke',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-700 text-xs">
            © {new Date().getFullYear()} Local Card Shop. All rights reserved.
          </p>
